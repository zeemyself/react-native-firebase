...
export type IOSActionOptionType = $Values<typeof IOSActionOption>;
...
export type IOSCategoryOptions = {|
  ...
  hiddenPreviewShowsSubtitle?: boolean,
  hiddenPreviewShowsTitle?: boolean,
|};

export type NativeIOSAction = {|
  actionId: string,
  options?: IOSActionOptions,
  title: string,
|};

export type NativeIOSCategory = {|
  actions: NativeIOSAction[],
  categoryId: string,
  hiddenPreviewsBodyPlaceholder?: string,
  intentIds: string[],
  options?: IOSCategoryOptions,
|};
